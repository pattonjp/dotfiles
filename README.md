...
`dodotfiles_updatet` is a simple script that installs some dependencies, sets sane macOS
defaults, and so on. Tweak this script, and occasionally run `dotfiles_update` from
...
I forked [holman](https://github.com/holman)' excellent
